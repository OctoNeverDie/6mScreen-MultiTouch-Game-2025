...
def process_image_with_alpha(image_path, output_dir, blur_ksize=15, mean_low=0, var_low=50, mean_high=0, var_high=400):
    ...
    # 출력 파일 이름 생성
    output_filename = f"teduri_noisy_alpha_{mean_low}_{var_low}_{mean_high}_{var_high}.png"
...
if __name__ == "__main__":
    input_image_path = "C:/Users/JSY/Desktop/multitouch/teduriG.png"  # 입력 이미지 경로
    output_directory = "C:/Users/JSY/Desktop/multitouch"  # 출력 이미지 디렉토리
    process_image_with_alpha(
        input_image_path,
        output_directory,
        blur_ksize=15,  # 저주파 필터 강도
        mean_low=0, var_low=0,  # 저주파 노이즈
        mean_high=-225, var_high=4000  # 고주파 노이즈
    )
